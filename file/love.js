(function(window){
    ...
    Seed.prototype = {
        ...
        drawText: function() {
            ...
            ctx.fillText("Rosh Click Me:) ", 30, -5);
    ...
    Footer.prototype = {
        draw: function() {
            ...
            ctx.save();
            ctx.strokeStyle = '#8B4513'; // Brown color for ground
            ctx.lineWidth = this.height * 2; // Make it thicker but not crazy
            ctx.lineCap = 'round';
            ctx.lineJoin = 'round';
            ctx.translate(point.x, point.y);
            ctx.beginPath();
    ...
    Branch.prototype = {
        ...
        draw: function(p) {
            ...
            ctx.save();
        	ctx.beginPath();
        	ctx.fillStyle = '#8B4513'; // Brown color for tree branches
